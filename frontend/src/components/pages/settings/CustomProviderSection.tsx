...
function CustomStatusDot({ provider }: { provider: CustomProviderInfo }) {
  ...
  const label = ready ? t("customProvider.statusConnected") : t("customProvider.statusUnconfigured");
  ...
  return (
    <div className="mt-3 border-t border-gray-800 pt-3">
      ...
      >
        ...
        <span>{t("customProvider.addButton")}</span>
      </button>
    </div>
  );
}
