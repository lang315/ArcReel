...
describe("CharacterCard", () => {
  ...
  it("renders existing saved reference image", () => {
    ...
    expect(screen.getByAltText("character.referenceAlt")).toHaveAttribute(
      "src",
  ...
  it("keeps selected reference file until save and submits it in the payload", async () => {
    ...
    expect(screen.getByText("character.pendingReference")).toBeInTheDocument();
  ...
  it("auto-resizes the description textarea as content grows", async () => {
    ...
    const textarea = screen.getByPlaceholderText("character.descriptionPlaceholder");
