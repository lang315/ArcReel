...
export function DialogueListEditor({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <span className="text-[11px] text-gray-500">{t("dialogue.label")}</span>
...
placeholder={t("dialogue.speakerPlaceholder")}
...
placeholder={t("dialogue.linePlaceholder")}
