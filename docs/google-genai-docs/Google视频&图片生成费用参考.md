...
## 🎬 Veo 3.1 / Veo 3.1 Fast Video Generation Pricing (billed per second)

> AI Studio and Vertex AI prices are identical

### Veo 3.1 (Standard)

| Resolution   | Audio      | Unit Price ($/second) | 8-second video cost |
| ------------ | ---------- | --------------------- | ------------------- |
...
### Veo 3.1 Fast (Lower cost / Faster)
...
##### Input image (as reference image)
...
> gemini-3.1-flash 2K image cost is approximately **75%** of gemini-3-pro ($0.101 vs $0.134)
